...
const Sunscreen = () => {
  ...
  const features = [
    {text:"Advanced UV Filters",icon: Sun},
    {text:"Light & Silky Gel-Cream Texture",icon: Droplets},
    {text:"Fragrance-Free & Gentle",icon: Heart},
    {text:"Layers smoothly - no pilling, no breakouts",icon: Check},
    {text:"Non-comedogenic, won't clog pores",icon: Check},
  ];

  const [selectedIngredient, setSelectedIngredient] = useState<string>("Zinc Oxide");
  ...
  return (
    <>
      ...
      <ProductFAQ slug="sunscreen"/>
      <ProductReview slug="sunscreen" />
      <Footer />
    </>
  );
};
